...
public class CheckoutActivity extends BaseActivity {
	...
	class Adapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.textViewQty.setText(String.valueOf(item.quantity));
			...
			holder.buttonDone.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					holder.circleButtonViewQty.setAsQty(getItem(holder.position).quantity);
				}
			});
			...
			holder.circleButtonViewMinus.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					ViewHolder holder = (ViewHolder) v.getTag();
					holder.textViewQty.setText(String.valueOf(--getItem(holder.position).quantity));
				}
			});
