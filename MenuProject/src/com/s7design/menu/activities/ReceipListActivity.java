...
public class ReceipListActivity extends BaseActivity {
	...
	class ReceiptListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.sendEmail.setOnClickListener(new OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					Toast.makeText(getApplicationContext(), "Restaurant: " + item.getRestaurantName() + "\nDate: " + item.getDate() + "\nAmmount: " + item.getAmmount(), Toast.LENGTH_SHORT).show();
				}
			});
